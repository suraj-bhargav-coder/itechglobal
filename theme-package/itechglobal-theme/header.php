...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .btn-primary { background: var(--accent); color: #fff; box-shadow: 0 14px 28px rgba(26, 167, 229, 0.28); }
    ...
    .read-more summary { cursor: pointer; font-weight: 700; color: var(--accent); list-style: none; margin-top: 10px; }
    .read-more summary::-webkit-details-marker { display: none; }
    .read-more[open] summary { margin-bottom: 8px; }
    .read-more-content p { margin: 0 0 10px; color: var(--muted); }
    .read-more-content p:last-child { margin-bottom: 0; }
